...
from . import indent_views
from . import home_collection_views
...
urlpatterns = [
    ...
    path('medicine-requisitions/', indent_views.medicine_requisitions, name='medicine_requisitions'),
    path('medicine-requisitions/<path:mr_number>/', indent_views.medicine_requisition_detail, name='medicine_requisition_detail'),
    path('material-items/', indent_views.get_material_items, name='get_material_items'),
    path('material-requisitions/export-excel/', indent_views.export_material_requisitions_excel, name='export_material_requisitions_excel'),
    path('material-requisitions/', indent_views.material_requisitions, name='material_requisitions'),
    path('material-requisitions/<path:mr_number>/', indent_views.material_requisition_detail, name='material_requisition_detail'),
    path('home-collections/', home_collection_views.home_collections, name='home_collections'),
    path('home-collections/<str:collection_id>/accept/', home_collection_views.accept_home_collection, name='accept_home_collection'),
]